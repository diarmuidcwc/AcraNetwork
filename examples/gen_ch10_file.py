...
def get_time_pkt(
    run_time_s: int, starttime: PTPTime, delta_s: PTPTime = ONE_SECOND, format: int = 1
) -> typing.Generator[ch10.Chapter10, None, None]:
    """
...
def get_pcm_pkt(
    count: int, starttime: PTPTime, subframe_cnt: int, start_seq: int, sample_rate: int = 100, minor_frm_size: int = 32
) -> typing.Generator[ch10.Chapter10, None, None]:
    """
    Generate a time packet
    """
...
def main(args):
    ...
    with chf as ch10file:
        ch10file.write(get_tmats_ch10(args.tmats, ptp_start_time.to_rtc()))
